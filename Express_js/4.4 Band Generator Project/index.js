...
app.post("/submit", (req, res) => {
  ...
  var adjrandomNumber = Math.floor(Math.random()*adj.length);
  var nounrandomNumber = Math.floor(Math.random()*noun.length);
  console.log(adjrandomNumber,nounrandomNumber);
  var genname = adj[adjrandomNumber] + ' '+ noun[nounrandomNumber]
  console.log("genname",genname);
  res.render("index.ejs",{Name:genname})
});
